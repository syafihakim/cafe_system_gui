...
class Window_TambahMakanan(ctk.CTkToplevel):
    def __init__(self):
        ...
        self.main_label = ctk.CTkLabel(master=self, text="TAMBAH MAKANAN", text_font=("Arial", 25))
        ...
        entry_food_name.grid(row=1, column=1, sticky="ew", pady=10)
        entry_food_price = ctk.CTkEntry(self, placeholder_text="Harga", text_font=("Arial", 30))
        entry_food_price.grid(row=2, column=1, sticky="ew", pady=10)
    ...
    def add_food_to_db(self, food_name, food_price):
        ...
        food_dict[food_name] = food_price
